...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  try {
    ...
    console.warn(
      "Designer profile fetch failed, using local data if available:",
      err,
    );
  }
  ...
  let products = [
    {
      name: "Ankara Bracelet",
      price: "$32",
      stock: "12 units",
      status: "Active",
      image: "../images/ankara bracelet.jpg",
    },
    {
      ...
      stock: "12 units",
      status: "Active",
      image: "../images/cowries necklace.jpg",
    },
    {
      ...
      stock: "12 units",
      status: "Active",
      image: "../images/beaded-earrings.jpg",
    },
    {
      name: "Ankara Sandals",
      price: "$24",
      stock: "12 units",
      status: "Active",
      image: "../images/ankara-sandals.jpg",
    },
  ];
  ...
  function renderProducts() {
    ...
    document.querySelectorAll(".edit-icon").forEach((icon) => {
      icon.addEventListener("click", (e) => {
        ...
        document.getElementById("prodPrice").value = prod.price.replace(
          /\$/g,
          "",
        );
        document.getElementById("prodStock").value = prod.stock.replace(
          /[^0-9]/g,
          "",
        );
        if (prod.image) {
  ...
  profileForm.addEventListener("submit", (e) => {
    ...
    const existing = JSON.parse(
      localStorage.getItem("designerProfile") || "{}",
    );
    const updated = {
